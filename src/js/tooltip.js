    ...
    function setPosition(parent, tooltip) {
        ...
        switch(position) {
            case 'top':
                ...
                tooltip.style.left = parentCoords.left + (parentCoords.width - tooltip.offsetWidth) / 2 + 'px'
                break
            case 'bottom':
            ...
            case 'right':
                ...
                tooltip.style.top = parentCoords.top + (parentCoords.height - tooltip.offsetHeight) / 2 + 'px'
